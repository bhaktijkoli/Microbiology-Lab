Module AppMain
    ...
    Public Function init()
        ...
        Try
            ...
            Database.Database.ExecuteSqlCommand("CREATE TABLE IF NOT EXISTS `Pathogens` ( `id` INTEGER PRIMARY KEY AUTOINCREMENT, `name` TEXT )")
            Database.Database.ExecuteSqlCommand("CREATE TABLE IF NOT EXISTS `GramPositives` ( `id` INTEGER PRIMARY KEY AUTOINCREMENT, `name` TEXT )")
            Database.Database.ExecuteSqlCommand("CREATE TABLE IF NOT EXISTS `GramNegatives` ( `id` INTEGER PRIMARY KEY AUTOINCREMENT, `name` TEXT )")
